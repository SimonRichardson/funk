...
// ********** Code for Product **************
function Product() {}
Product.prototype._makeString = function(separator) {
  var total = this.get$productArity();
  var buffer = new StringBufferImpl("");
  for (var i = (0);
   i < total; i++) {
    var element = this.productElement(i);
...
Product.prototype.iterator = function() {
  return new ProductIterator(this);
}
Product.prototype.toString = function() {
  if ((0) == this.get$productArity()) {
    return this.get$productPrefix();
  }
  return ("" + this.get$productPrefix() + "(" + this._makeString(", ") + ")");
}
// ********** Code for ProductIterator **************
function ProductIterator(product) {
  this._product = product;
  this._arity = product.get$productArity();
  this._index = (0);
}
ProductIterator.prototype.hasNext = function() {
...
// ********** Code for RangeError **************
function RangeError(_msg) {
  this._msg = _msg;
}
RangeError.empty$ctor = function() {
  this._msg = "Range error";
}
RangeError.empty$ctor.prototype = RangeError.prototype;
RangeError.prototype.toString = function() {
  return ("RangeError: '" + this._msg + "'");
}
// ********** Code for TupleImpl2 **************
$inherits(TupleImpl2, Product);
function TupleImpl2() {}
TupleImpl2.prototype.get$_1 = function() {
  return this.__1;
}
TupleImpl2.prototype.get$_2 = function() {
  return this.__2;
}
TupleImpl2.prototype.productElement = function(index) {
  if (index >= this.get$productArity()) {
...
TupleImpl2.prototype.get$productArity = function() {
  return (2);
}
TupleImpl2.prototype.get$productPrefix = function() {
  return "Tuple";
}
// ********** Code for None **************
$inherits(None, Product);
function None() {}
None.prototype.get$productArity = function() {
  return (0);
}
None.prototype.get$productPrefix = function() {
  return "None";
}
None.prototype.productElement = function(index) {
  $throw(new RangeError.empty$ctor());
}
// ********** Code for top level **************
function main() {
