...
class PartialFunction2Types {
    ...
    public static function fromFunction<T1, T2, R>(func : Function2<T1, T2, R>) : PartialFunction2<T1, T2, R> {
        return fromPartial(Partial2(function(value0, value1) return true, func));
    }
