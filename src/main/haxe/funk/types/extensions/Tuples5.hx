...
class Tuples5 {
	...
	public static function _3<T1, T2, T3, T4, T5>(tuple : Tuple5<T1, T2, T3, T4, T5>) : T2 {
		return switch(tuple) {
			case tuple5(_, _, value, _, _): value;
		}
	}

	public static function _4<T1, T2, T3, T4, T5>(tuple : Tuple5<T1, T2, T3, T4, T5>) : T2 {
		return switch(tuple) {
			case tuple5(_, _, _, value, _): value;
		}
	}

	public static function _5<T1, T2, T3, T4, T5>(tuple : Tuple5<T1, T2, T3, T4, T5>) : T2 {
		return switch(tuple) {
			...
			case tuple5(t1_0, t2_0, t3_0, t4_0, t5_0):
				switch (b) {
					case tuple5(t1_1, t2_1, t3_1, t4_1, t5_1):
						...
						var eq3 : Predicate2<T, T> = function(a, b) : Bool {
							return null == func3 ? func3(a, b) : a == b;
						};
						var eq4 : Predicate2<T, T> = function(a, b) : Bool {
							return null == func4 ? func4(a, b) : a == b;
						};
						var eq5 : Predicate2<T, T> = function(a, b) : Bool {
