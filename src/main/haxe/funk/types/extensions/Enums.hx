...
class Enums {
    ...
    public static function createAll<T>(e : Enum<T>) : Array<T> return Type.allEnums(e);

    public static function getConstructors<T>(e : Enum<T>) : Array<String> return Type.getEnumConstructs(e);

    public static function getName<T>(e : Enum<T>) : String return Type.getEnumName(e);
}
