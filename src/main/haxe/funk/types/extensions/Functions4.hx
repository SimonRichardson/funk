...
class Functions4 {
	...
	public static function tuple<T1, T2, T3, T4, R>(	func : Function4<T1, T2, T3, T4, R>
	...
	public static function untuple<T1, T2, T3, T4, R>(	func : Function1<Tuple4<T1, T2, T3, T4>, R>
														) : Function4<T1, T2, T3, T4, R> {
	...
	public static function equals<T1, T2, T3, T4, R>(	func0 : Function4<T1, T2, T3, T4, R>, 
														func1 : Function4<T1, T2, T3, T4, R>
														) : Bool {
