...
class Tuples4 {
	...
	public static function _3<T1, T2, T3, T4>(tuple : Tuple4<T1, T2, T3, T4>) : T2 {
		return switch(tuple) {
			case tuple4(_, _, value, _): value;
		}
	}

	public static function _4<T1, T2, T3, T4>(tuple : Tuple4<T1, T2, T3, T4>) : T2 {
		return switch(tuple) {
			...
			case tuple4(t1_0, t2_0, t3_0, t4_0):
				switch (b) {
					case tuple4(t1_1, t2_1, t3_1, t4_1):
						...
						eq1(t1_0, t1_1) && eq2(t2_0, t2_1) && eq3(t3_0, t3_1) && eq4(t4_0, t4_1);
				} 
		}
	}
	...
	public static function toString<T1, T2, T3, T4>(tuple : Tuple4<T1, T2, T3, T4>) : String {
		return switch (tuple) {
			case tuple4(t1, t2, t3, t4): Std.format('($t1, $t2, $t3, $t4)');
		}
	}
}