...
typedef Executioner3<T1, T2, T3, R> = {
    function execute(value0 : T1, value1 : T2, value2 : T3) : R;
}
...
class Function3Types {
    ...
    public static function swallowWith<T1, T2, T3, R>(  func : Function3<T1, T2, T3, R>, 
                                                        res : R
                                                        ) : Function3<T1, T2, T3, R> {
