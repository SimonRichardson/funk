...
class Predicate1Types {
    ...
    public static function and<T1>(p0 : Predicate1<T1>, p1 : Predicate1<T1>) : Predicate1<T1> {
        return function(value0) return p0(value0) && p1(value0);
    }

    public static function not<T1>(p : Predicate1<T1>) : Predicate1<T1> return function(value0) return !p(value0);
    ...
    public static function ifElse<T1, R>(   p : Predicate1<T1>,
        ...
        return function(value0) return p(value0) ? ifFunc() : elseFunc();
    }
}
