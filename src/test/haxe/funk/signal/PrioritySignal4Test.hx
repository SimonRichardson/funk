...
import funk.signal.PrioritySignal4;
...
class PrioritySignal4Test {

	private var signal : PrioritySignal4<Int, Int, Int, Int>;

	@Before
	public function setup() {
		signal = new PrioritySignal4<Int, Int, Int, Int>();
	}
	...
	public function when_adding_two_items_with_larger_priority__should_dispatch_in_order() : Void {
		...
		signal.addWithPriority(function(value0, value1, value2, value3){
			called0 = true;
		}, 1);
		signal.addWithPriority(function(value0, value1, value2, value3){
			if(called0) {
	...
	public function when_adding_once_with_priority__should_size_be_1() : Void {
		signal.addOnceWithPriority(function(value0, value1, value2, value3){
		});
		signal.size.areEqual(1);
	}
