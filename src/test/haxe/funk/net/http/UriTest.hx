...
class UriTest {
	...
	public function should_calling_a_url_on_parameters_return_size_of_1() : Void {
		"http://www.localhost.com:8080?id=0#hash".fromUri().parameters().size().areEqual(1);
	}

	@Test
	public function should_calling_a_url_on_parameters_return_size_of_4() : Void {
		"http://www.localhost.com:8080?id0=0&id1=1&id2=2&id3=3".fromUri().parameters().size().areEqual(4);
	}

	@Test
	public function should_calling_a_url_on_parameters_return_size_of_4_with_hash() : Void {
		"http://www.localhost.com:8080?id0=0&id1=1&id2=2&id3=3#hash".fromUri().parameters().size().areEqual(4);
	}
