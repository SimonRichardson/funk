...
class Predicate5Test {
	...
	public function when_calling_and_same_result__should_return_true() : Void {
		var a = function (value0, value1, value2, value3, value4) return true;
		var b = function (value0, value1, value2, value3, value4) return true;
		a.and(b)(true, true, true, true, true).isTrue();
	}

	@Test
	public function when_calling_and_with_different_result__should_return_false() : Void {
		var a = function (value0, value1, value2, value3, value4) return true;
		var b = function (value0, value1, value2, value3, value4) return false;
		a.and(b)(true, true, true, true, true).isFalse();
	}
	...
	public function when_calling_not_with_false_result__should_be_true() : Void {
		var a = function (value0, value1, value2, value3, value4) return false;
		a.not()(true, true, true, true, true).isTrue();
	}
	...
	public function when_calling_or_same_result__should_return_true() : Void {
		var a = function (value0, value1, value2, value3, value4) return true;
		var b = function (value0, value1, value2, value3, value4) return true;
		a.or(b)(true, true, true, true, true).isTrue();
	}
	...
	public function when_calling_or_with_same_false_result__should_return_false() : Void {
		var a = function (value0, value1, value2, value3, value4) return false;
		var b = function (value0, value1, value2, value3, value4) return false;
		a.or(b)(true, true, true, true, true).isFalse();
	}
