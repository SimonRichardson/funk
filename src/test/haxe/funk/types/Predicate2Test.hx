...
import funk.types.extensions.Predicates2;
import massive.munit.Assert;

using Type;
using funk.types.extensions.Predicates2;
...
class Predicate2Test {
	...
	public function when_calling_and_same_result__should_return_true() : Void {
		var a = function (value0, value1) return true;
		var b = function (value0, value1) return true;
		a.and(b)(true, true).isTrue();
	}

	@Test
	public function when_calling_and_with_different_result__should_return_false() : Void {
		var a = function (value0, value1) return true;
		var b = function (value0, value1) return false;
		a.and(b)(true, true).isFalse();
	}
	...
	public function when_calling_not_with_false_result__should_be_true() : Void {
		var a = function (value0, value1) return false;
		a.not()(true, true).isTrue();
	}
