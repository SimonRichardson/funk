...
import funk.types.extensions.Predicates3;
import massive.munit.Assert;

using Type;
using funk.types.extensions.Predicates3;
...
class Predicate3Test {
	...
	public function when_calling_and_same_result__should_return_true() : Void {
		var a = function (value0, value1, value2) return true;
		var b = function (value0, value1, value2) return true;
		a.and(b)(true, true, true).isTrue();
	}

	@Test
	public function when_calling_and_with_different_result__should_return_false() : Void {
		var a = function (value0, value1, value2) return true;
		var b = function (value0, value1, value2) return false;
		a.and(b)(true, true, true).isFalse();
	}
	...
	public function when_calling_not_with_false_result__should_be_true() : Void {
		var a = function (value0, value1, value2) return false;
		a.not()(true, true, true).isTrue();
	}
